# Guide enseignant - Mission Plainpalais 2026

## Format
- Durée cible : 30 minutes.
- Groupes : 3 à 5 élèves.
...
4. À validation, le groupe envoie au professeur :
...
- aperçu des étapes,
- liste des codes attendus,
- état brut stocké localement,
- bouton de réinitialisation.

## Règles pédagogiques mobilisées dans le jeu
- distinction entre Collège, ECG, CFP Commerce, SeFoP,
- logique choix A / B / préférentiel,
- SeFoP en choix A = pas de choix B,
- inscription par filière (pas établissement),
- contraintes de langues,
- cohérence OS/DF,
- usage des codes de filière.

## Réinitialiser entre deux classes
- Ouvrir `teacher.html`.
- Cliquer sur `Réinitialiser la partie`.
- Confirmer.
